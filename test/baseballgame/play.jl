...
@test count_balls([1, 2, 3, 4], [2, 3, 1, 9], N) == (strikes=0, balls=3)
@test count_balls([1, 2, 3, 4], [1, 3, 5, 9], N) == (strikes=1, balls=1)
@test count_balls([1, 2, 3, 4], [1, 3, 2, 9], N) == (strikes=1, balls=2)
@test count_balls([1, 2, 3, 4], [1, 2, 5, 9], N) == (strikes=2, balls=0)
